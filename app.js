...
//   try {
//     //shedule for cronjob flow differs from manual triggering, as we want only one job to run and mark the other one as failed.(more visible to user)
...
//   res.send('Hello deltas-healing-initiator');
// });
